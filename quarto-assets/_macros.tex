...
\newcommand{\sumn}[0]{\sum_{i=1}^{n}}
\newcommand{\prodd}[2]{\prod_{#1}^{#2}}
\newcommand{\prodn}[0]{\prod_{i=1}^{n}}
\newcommand{\intt}[2]{\int_{#1}^{#2}}
\newcommand{\partt}[1]{\frac{\partial}{\partial #1}}
\newcommand{\parttt}[1]{\frac{\partial^2}{\partial #1^2}}
\newcommand{\bx}[0]{\bold{x}}
\newcommand{\bth}[0]{\boldsymbol{\theta}}
\newcommand{\bmu}[0]{\boldsymbol{\mu}}
\newcommand{\br}[1]{\{#1\}}
\newcommand{\verb}[1]{\begin{verbatim}#1\end{verbatim}}
\newcommand{\sett}[1]{\setcounter{question}{#1}}
